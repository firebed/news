<div class="card shadow-sm mb-4">
    <div class="card-body">
        ...
        <div class="mb-3" x-data="{ count: 0 }" x-init="count = $refs.input.value.length">
            ...
            <x-news::input.textarea wire:model.defer="article.description" x-ref="input" x-on:keydown.enter="event.preventDefault()" x-on:keyup="count = $refs.input.value.length" error="article.description" rows="3" maxlength="160" id="description"/>
