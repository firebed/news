    ...
    <div class="card-body">
        ...
        <div class="row gx-2">
            <div class="col">
                ...
                <x-news::input.select wire:model="article.type_id" id="type-id" error="article.type_id">
            ...
            @if($article->type_id && $this->types->find($article->type_id)->isColumn())
                <div class="col">
                    ...
                    <x-news::input.select wire:model.defer="article.author_id" id="author" error="article.author_id">
