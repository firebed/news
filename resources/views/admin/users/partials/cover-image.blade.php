<div class="card shadow-sm">
    <div class="card-body">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            @can('Upload photo')
                <div class="mt-3">
                    <x-input.file wire:model="cover_photo" hidden id="cover-photo"/>
                    <label wire:loading.class="disabled" wire:target="cover_photo" for="cover-photo" class="btn btn-sm btn-secondary">
                        <x-icons.upload wire:loading.remove="" wire:target="cover_photo"></x-icons.upload>
                        <x-icons.spinner wire:loading wire:target="cover_photo"></x-icons.spinner>
                        {{ __("Upload") }}
                    </label>
                </div>
            @endcan
