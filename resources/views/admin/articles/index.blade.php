        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="row row-cols-1 row-cols-sm-3 g-2">
                    <div class="col">
                        <x-input.search wire:model="article_id" id="article-id" placeholder="{{ __('Search by id') }}"/>
                    </div>

                    <div class="col">
                        <x-input.search wire:model="search" placeholder="{{ __('Search by content') }}"/>
                    </div>

                    <div class="col">
                        <x-input.select wire:model="selected_type">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="table-responsive" wire:loading.class="opacity-50">
                            @include('admin.articles.partials.articles-table')
                        </div>
                        {{ $articles->links() }}
                    </div>
                </div>
