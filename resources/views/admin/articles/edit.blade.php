...
<div>
    @include('admin.articles.partials.article-header', ['title' => __("Edit article")])

    <div class="row justify-content-center p-4">
        <div class="col-12 col-xxl-10">
            @include('admin.articles.partials.article-title')
            <div class="row g-4">
                <div class="col-12 col-xl-7 col-xxl-8">
                    @include('admin.articles.partials.article-content')
                    @include('admin.articles.partials.article-photos')
                    @include('admin.articles.partials.article-delete')
                </div>
                <div class="col-12 col-xl-5 col-xxl-4">
                    @include('admin.articles.partials.article-publishing')
